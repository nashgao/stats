...
/// Source selection for the menu bar watts readout, as a magnitude (the
/// menu bar shows no sign). Source table (all verified live by
/// step-response against a CPU load, 2026-09-25):
...
/// there; nil only when no SMC power keys respond.
